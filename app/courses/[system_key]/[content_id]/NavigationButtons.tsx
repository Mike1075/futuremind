...
export function NavigationButtons({
  ...
  return (
    <div className="flex justify-between items-center pt-8 pr-20 md:pr-0 border-t border-gray-800">
      {prevContentId ? (
        <Link
          href={`/courses/${systemKey}/${prevContentId}`}
          className="flex items-center py-3 pr-3 -ml-1 pl-1 text-gray-400 hover:text-white transition-colors"
        >
      ...
      {nextContentId ? (
        isUnlocked ? (
          <Link
            ...
            className="flex items-center py-3 pl-3 pr-1 text-gray-400 hover:text-white transition-colors"
          >
            下一天
