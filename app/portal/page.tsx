...
import { PortalOptimizationService } from '@/lib/services/portal-optimization.service'
...
export default function PortalPage() {
  ...
  const loadEnrolledCourses = async (userId: string) => {
    try {
      ...
      // ✅ 使用优化后的批量加载服务（减少查询次数，提升性能）
      const enrolled = await PortalOptimizationService.loadEnrolledCoursesOptimized(
        userId,
        enrolledData || []
      )
