        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-h2 font-bold text-starlight">欢迎来到地球 - 选课学员</h1>
                <p className="text-small text-cyan-300 mt-1">管理课程学员</p>
              </div>
            </div>
            <button
              onClick={() => setShowAddModal(true)}
              className="px-4 py-2 bg-gradient-to-r from-cyan-600 to-green-600 hover:from-cyan-700 hover:to-green-700 text-starlight rounded-lg font-medium transition-all flex items-center gap-2"
            >
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 card-glass text-starlight placeholder-gray-400 focus:outline-none focus:border-cyan-500"
            />
          </div>
        </div>
            ...
            {filteredStudents.length === 0 ? (
              ...
              filteredStudents.map((student) => (
                <div key={student.id} className="p-4 hover:bg-white/5 transition-all flex items-center justify-between">
                  <div>
                    <p className="text-starlight font-medium">{student.full_name || '未设置姓名'}</p>
                    <p className="text-starlight-muted text-small mt-1">{student.email}</p>
                    <p className="text-starlight-dim text-xs mt-1">
        ...
        <div className="fixed inset-0 bg-cosmic-void/80 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 rounded-lg border border-white/10 w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
            <div className="p-6 border-b border-white/10">
              <h2 className="text-h3 font-bold text-starlight">添加学员到课程</h2>
              <p className="text-starlight-muted text-small mt-2">可以添加学员、老师或校长</p>
            </div>
            <div className="p-6 overflow-y-auto flex-1">
              ...
              <div className="mb-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="搜索姓名或邮箱..."
                    className="w-full pl-10 pr-4 py-2 card-glass text-starlight placeholder-gray-400 focus:outline-none focus:border-cyan-500"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                {availableUsers.length === 0 ? (
                  <p className="text-starlight-muted text-center py-8">所有学员都已添加</p>
                ) : (
            ...
            <div className="p-6 border-t border-white/10">
              <button
                ...
                className="w-full px-4 py-2 bg-white/10 hover:bg-white/20 text-starlight rounded-lg transition-all"
              >
                取消
              </button>
            </div>
