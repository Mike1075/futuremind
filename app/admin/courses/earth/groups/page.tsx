        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">欢迎来到地球 - 课程分组</h1>
                <p className="text-sm text-cyan-300 mt-1">管理课程分组</p>
              </div>
            </div>
            <button
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/10">
                  ...
                  <button
                    ...
                    className="text-cyan-400 hover:text-cyan-300 text-sm font-medium transition-all"
                  >
                    管理成员 →
                  </button>
                </div>
          ...
          <div className="bg-gray-900 rounded-lg border border-white/10 w-full max-w-md">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500 resize-none"
                />
              </div>
            </div>
            <div className="p-6 border-t border-white/10 flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-gradient-to-r from-cyan-600 to-green-600 hover:from-cyan-700 hover:to-green-700 text-white rounded-lg transition-all"
              >
                创建
              </button>
            </div>
