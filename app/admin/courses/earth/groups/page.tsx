        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-h2 font-bold text-starlight">欢迎来到地球 - 课程分组</h1>
                <p className="text-small text-cyan-300 mt-1">管理课程分组</p>
              </div>
            </div>
            <button
            ...
            groups.map((group) => (
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/10">
                  <p className="text-starlight-dim text-small">
                    创建于: {group.created_at ? new Date(group.created_at).toLocaleDateString('zh-CN') : '-'}
                  </p>
                  <button
                    onClick={() => router.push(`/admin/groups/${group.id}`)}
                    className="text-cyan-400 hover:text-cyan-300 text-small font-medium transition-all"
                  >
                    管理成员 →
                  </button>
                </div>
          ...
          <div className="card-glass w-full max-w-md">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="input-ethereal focus:border-cyan-500"
                />
              </div>
              <div>
                <label className="block text-small font-medium text-gray-300 mb-2">
                ...
                <textarea
                  ...
                  rows={3}
                  className="input-ethereal focus:border-cyan-500 resize-none"
                />
              </div>
            </div>
            <div className="p-6 border-t border-white/10 flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2 bg-gradient-to-r from-cyan-600 to-green-600 hover:from-cyan-700 hover:to-green-700 text-starlight rounded-lg transition-all"
              >
                创建
              </button>
            </div>
