              ...
              >
                ...
                {!submissionResult && (
                  <>
                    ...
                    {/* 上传进度提示 */}
                    {uploading && (
                      <div className="mb-4 flex items-center gap-3 bg-amber-500/10 border border-amber-500/30 rounded-lg p-3 backdrop-blur-sm">
                        ...
                        <p className="text-sm text-amber-400">正在上传文件和提交作业...</p>
                      </div>
                    )}
