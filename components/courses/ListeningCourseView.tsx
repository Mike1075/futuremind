...
// 曲线路径节点位置（百分比）- 优化后的耳朵轮廓形状
// 参考耳朵简笔画：外耳轮C形 + 圆润耳垂 + 内耳轮
const PATH_POINTS = [
  { x: 35, y: 12 },   // Day 1 - 耳朵顶部起点
  { x: 48, y: 8 },    // Day 2 - 外耳轮顶端（最高点）
  { x: 62, y: 10 },   // Day 3 - 开始向外弯曲
  { x: 74, y: 16 },   // Day 4 - 外耳轮向外扩展
  { x: 82, y: 26 },   // Day 5 - 外耳轮中上部
  { x: 86, y: 40 },   // Day 6 - 外耳轮中部（最外侧）
  { x: 85, y: 54 },   // Day 7 - 外耳轮中下部
  { x: 80, y: 66 },   // Day 8 - 向耳垂过渡
  { x: 72, y: 76 },   // Day 9 - 耳垂上部
  { x: 60, y: 84 },   // Day 10 - 耳垂中部
  { x: 46, y: 88 },   // Day 11 - 耳垂底部（最低点）
  { x: 34, y: 84 },   // Day 12 - 耳垂内侧，开始向上
  { x: 26, y: 72 },   // Day 13 - 内耳轮下部
  { x: 22, y: 56 },   // Day 14 - 内耳轮中部，向上收尾
]
