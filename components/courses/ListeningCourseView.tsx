...
// 曲线路径节点位置（百分比）- 缩小后的耳朵轮廓 + 耳洞勾勾
// 缩小到适合屏幕显示，添加耳洞回勾效果
const PATH_POINTS = [
  { x: 38, y: 18 },   // Day 1 - 耳朵顶部起点
  { x: 50, y: 14 },   // Day 2 - 外耳轮顶端（最高点）
  { x: 62, y: 16 },   // Day 3 - 开始向外弯曲
  { x: 72, y: 22 },   // Day 4 - 外耳轮向外扩展
  { x: 78, y: 32 },   // Day 5 - 外耳轮中上部
  { x: 82, y: 45 },   // Day 6 - 外耳轮中部（最外侧）
  { x: 80, y: 58 },   // Day 7 - 外耳轮中下部
  { x: 74, y: 68 },   // Day 8 - 向耳垂过渡
  { x: 64, y: 76 },   // Day 9 - 耳垂上部
  { x: 52, y: 82 },   // Day 10 - 耳垂中部
