...
interface NovemberCourseViewProps {
...
const NOVEMBER_COLORS = Array.from({ length: 30 }, (_, i) => {
  const hue = (i / 29) * 330
...
export function NovemberCourseView({
  courseSystem,
  contents,
  completionMap,
  scoreMap,
  bypassScoreCheck = false
}: NovemberCourseViewProps) {
  return (
    <MeditationCalendarView
      ...
      year={2026}
      month={11}
      systemKey="compassion_rebirth"
      colors={NOVEMBER_COLORS}
      titleGradient="from-fuchsia-400 via-pink-400 to-rose-400"
      subtitle="克里希那穆提《生命之书》十一月主题：死亡、爱与慈悲"
    />
  )
}
