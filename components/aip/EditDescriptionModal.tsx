        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-3">
            <button
              ...
              onClick={handleClose}
              disabled={loading}
              className="flex-1 px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 rounded-lg transition-colors focus:outline-none focus:ring-0 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              取消
            </button>
            <button
