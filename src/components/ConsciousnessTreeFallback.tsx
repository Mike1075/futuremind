...
interface ConsciousnessTreeFallbackProps {
  currentDay: number
  completedTasks: string[]
  className?: string
}

export default function ConsciousnessTreeFallback({
  currentDay,
  completedTasks: _,
  className = ''
}: ConsciousnessTreeFallbackProps) {
            ...
            return (
              ...
              >
                ...
                {index > 0 && (
                  ...
                  >
                    <div className="w-0.5 h-10 bg-gradient-to-t from-green-400 to-transparent"></div>
                  </motion.div>
                )}
