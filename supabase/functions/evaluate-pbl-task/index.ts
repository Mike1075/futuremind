...
**返回格式示例**（分数>=90时）：
{
  "feedback": "你的观察非常细致，很好地完成了本次任务...",
  "score": 92,
  "suggestions": ""
}

**返回格式示例**（分数<90时，必须提供改进建议）：
{
  "feedback": "你已经开始思考这个问题了，这是很好的开始...",
  "score": 75,
  "suggestions": "为了让你的作业更出色，建议你：1) 可以尝试从多个角度思考这个问题；2) 下次提交时，不妨加入一些具体的例子来支持你的观点。相信你下次会做得更好！"
}
